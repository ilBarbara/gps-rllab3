...
from gps.agent.rllab3.agent_rllab3 import AgentRllab3Ant
...
EXP_DIR = BASE_DIR + '/../experiments/rllab3_ant_example/'
...
agent = {
    ...
    'x0': np.concatenate([np.array([0.1, 0.1, -1.54, -1.7, 1.54, -0.2, 0, 0]),
                          np.zeros(8)]),
    'dt': 0.05,
    'substeps': 5,
