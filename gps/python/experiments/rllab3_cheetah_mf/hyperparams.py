...
from gps.algorithm.algorithm_Reinforce_Cheetah import AlgorithmReinforce
...
from gps.algorithm.policy_opt.policy_opt_mf import PolicyOptMf
...
EXP_DIR = BASE_DIR + '/experiments/rllab3_cheetah_mf/'
