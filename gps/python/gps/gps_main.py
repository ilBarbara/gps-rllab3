...
class GPSMain(object):
    ...
    def __init__(self, config, quit_on_end=False):
        ...
        self.agent = config['agent']['type'](config['agent'])  #see how class AgentMuJoCo __init__ [_setup_conditions(), _setup_world()]
    ...
    def _take_sample(self, itr, cond, i):
        ...
        if self.algorithm._hyperparams['sample_on_policy'] \
            ...
            pol = self.algorithm.cur[cond].traj_distr   #use traj_distr to sample
        self.agent.sample(
            pol, cond,
