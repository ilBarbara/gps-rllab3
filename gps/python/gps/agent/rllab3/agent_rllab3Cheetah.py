...
class AgentRllab3HalfCheetah(Agent):
    """
    ...
    def _set_sample(self, sample, mj_X, reward, t, condition, feature_fn=None):
        ...
        """
        sample.set(END_EFFECTOR_POINTS, mj_X[0:8], t=t+1)    #Set _data in sample class
        sample.set(JOINT_VELOCITIES, mj_X[8:17], t=t+1)
        sample.set(JOINT_ANGLES, mj_X[17:20], t=t+1)
        sample.set(END_EFFECTOR_POINT_VELOCITIES, mj_X[20:23], t=t+1)
